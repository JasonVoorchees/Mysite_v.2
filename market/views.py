...
def market_shop(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "market/shop.html", {**context, "page_title": "Маркет — Магазин"})
...
def market_free(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "market/free.html", {**context, "page_title": "Маркет — Даром"})
...
def market_wanted(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "market/wanted.html", {**context, "page_title": "Маркет — Спрос"})
...
def market_swap(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "market/swap.html", {**context, "page_title": "Маркет — Обмен"})
...
def market_auction(request: HttpRequest, category_slug: str | None = None) -> HttpResponse:
    ...
    return render(request, "market/auction.html", {**context, "page_title": "Маркет — Аукцион"})
